...
#define STM32_PLLSAI_QDIV_ENABLED   DT_NODE_HAS_PROP(DT_NODELABEL(pllsai), qdiv)
#define STM32_PLLSAI_Q_DIVISOR_Q    DT_PROP_OR(DT_NODELABEL(pllsai), qdiv, 1)
#define STM32_PLLSAI_RDIV_ENABLED   DT_NODE_HAS_PROP(DT_NODELABEL(pllsai), rdiv)
#define STM32_PLLSAI_R_DIVISOR_R    DT_PROP_OR(DT_NODELABEL(pllsai), rdiv, 1)
#endif
